...
public class UD4Problema1Extended {
    ...
    public static void menu() {
        ...
        while (!input.hasNextInt() || (feedback = input.nextInt()) < 1 || feedback > 6) {
        ...
        switch (feedback) {
            ...
            case 5:
                sortBookList();
                System.out.println("Su listatado se ha ordenado correctamente");
                menu();
                break;
    ...
    //Este método confirma la finalización de la ejecución mediante la introducción de un caracter por el usuario

...
public class AddEmbarcacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String metrosEslora = request.getParameter("metrosSslora");
        String fabricacionYear = request.getParameter("fabricacionYear");
        String tipo = request.getParameter("tipo");
        
        String numeroMastiles = request.getParameter("numeroMastiles");
        String potencia = request.getParameter("potencia");
        String numCamarotes = request.getParameter("numCamarotes");

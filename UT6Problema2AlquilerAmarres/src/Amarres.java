...
public class Amarres {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("------------------");
        System.out.println("Prueba Puerto Extra");
        System.out.println("-------------------");
        
        Puerto p = new Puerto();
        p.addAlquilerAmarre(alquilerVelero1);
        p.addAlquilerAmarre(alquilerDeportiva1);
        p.addAlquilerAmarre(alquilerYate1);
        
        p.calcularIngresosTotales();
        
        System.out.println("---------------------");
        p.eliminarAlquilerAmarre(alquilerDeportiva1);
        p.calcularIngresosTotales();
